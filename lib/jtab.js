    ...
    for (var i = 1; i < this.chordArray.length; i++) {
      var fret =
        this.chordArray[i][0] >= 0
          ...
          : this.chordArray[i][0];
      var finger = use_caged_fingering
...
Raphael.fn.chord_fretboard = function (position, chord_name) {
  ...
  var chord_fretboard_path = this.path(
    this.svg_params(
      fret_left,
      this.margin_top,
